...
public class AffichageJeu extends Affichage {
	...
	private int[][] level; // A prendre comme r�f�rence je pense, dans la classe Map, ou alors
	// juste en param�tre � l'initialisation, dans le constructeur
	...
	public AffichageJeu(){
		...
		vue = new View(new FloatRect(0, 0, 11*SIZE, HAUTEUR)); // On d�finit la taille de la vue
		vue.setViewport(new FloatRect(0, 0, 11/16.f, 1)); // On d�finit la zone o� elle va s'afficher
	}	
